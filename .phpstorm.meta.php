...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'passport.private_key' => 'string',
            'passport.public_key' => 'string',
...
'passport.guard','passport.private_key','passport.public_key','passport.connection','queue.default',
...
'repository.generator.paths.criteria','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','repository::criteria.fields_not_accepted',
'repository::packages.prettus_laravel_validation_required','repository::packages.league_fractal_required',);
...
'PASSPORT_PRIVATE_KEY','PASSPORT_PUBLIC_KEY','PASSPORT_PERSONAL_ACCESS_CLIENT_ID','PASSPORT_PERSONAL_ACCESS_CLIENT_SECRET',);
